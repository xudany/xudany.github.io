...
#### 11. [!] (plugin babel) TypeError: Cannot read property 'length' of undefined
...
#### 12. [!] (plugin babel) Error: Babel 7.0.0-beta.56 has dropped support for the 'helpersNamespace' utility.
